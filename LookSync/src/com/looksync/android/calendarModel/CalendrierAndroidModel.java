package com.looksync.android.calendarModel;

public class CalendrierAndroidModel {
	public CalendrierAndroidModel() {
		super();
	}
	...
	public CalendrierAndroidModel(String description, String titre,
