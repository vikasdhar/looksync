...
//import roman10.tutorial.calendarops.R.layout;
...
public class SynchronizeProgressTab extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        m_text_event = (TextView) findViewById(R.id.text_event_outlook); //
        /*List<Appointment>*/ String events;
    	try { //TODO
			events =
    ...
    private void addEvent() {
    	...
    	l_event.put("title", "calendar test");
    ...
    private void addEvent2() {
    	...
    	l_intent.putExtra("title", "calendar test");
